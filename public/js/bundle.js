...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxpbm91cjIwMDMiLCJhIjoiY2xueGFsZTNoMGo5bjJtbXhtdG45cWZ3ZyJ9.kAyzfmxCnv94qp5dDJ3mYw';
  ...
  var coords = []; // Create an array to store route coordinates
...
exports.resetPass = exports.logout = exports.forgotPass = exports.auth = void 0;
...
var auth = exports.auth = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(inputData, type) {
    var url, _yield$axios, data;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: url,
            data: _objectSpread({}, inputData)
          });
        case 4:
          _yield$axios = _context.sent;
          data = _yield$axios.data;
          if (data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type !== 'login' ? 'Welcome to Natours ^_^' : 'Logged in successfully :)'));
            type === 'login' ? window.setTimeout(function () {
              location.assign('/');
...
var forgotPass = exports.forgotPass = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          if (data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email Sent !');
  ...
  return function forgotPass(_x3) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          if (data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password has been changed successfully.');
            window.setTimeout(function () {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NXWiqHHfCzf7X9YwRPStsF3oNWR7nUnatCYSSrZWsHlZUDkelvJU27vlMZ70nIOv3pAhwPA23SlX6bpEpgSDQU400kNqHPkII'); // Get checkout session from API
          _context.next = 4;
...
var forgotPassword = document.querySelector('.form--forpass');
var resetPassword = document.querySelector('.form--reset');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _auth.auth)(data, 'signup');
});
if (resetPassword) resetPassword.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.next = 10;
          return (0, _auth.resetPass)(password, passwordConfirm, window.location.pathname.split('/')[2]);
        case 10:
...
if (forgotPassword) forgotPassword.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  var data = {
    email: email
  };
  (0, _auth.forgotPass)(data);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12580" + '/');
